...
export default function privateInfo() {
    return (
        <>
            <PageTitle title="홍언니고기 - 개인정보처리방침" />
            <p>
                ㈜홍언니고기 푸드 (이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
                <br />
                <br />
                ...
                1. 홈페이지 회원 가입 및 관리
                <br />
                회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충
                ...
                <br />
                - 개인정보를 제공받는 자 : 신용카드 정보, 은행계좌 정보 등 대금결제에 필요한 정보
                <br />
                - 제공받는 자의 개인정보 이용목적 : 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 및 배송관련 정보
                <br />
                - 제공하는 개인정보 항목 : 성명, 주소, 연락처, 대금결제에 대한 정보
                <br />
                <br />
                <strong>제4조(이용자 및 법정대리인의 권리와 그 행사 방법)</strong>
                <br />
                <br />
                ...
                1. 홈페이지 회원 가입 및 관리
                <br />
                필수항목 (개인)&nbsp;&nbsp; : 이메일주소, 비밀번호, 주소, 연락처, 성별, 이름, 생일 <br />
                필수항목 (사업자) : 이메일주소, 비밀번호, 상호, 사업자번호, 대표자명, 연락처, 주소, 담당자명, <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;업태, 업종 <br />
                2. 재화 또는 서비스 제공
                <br />
                필수항목 : 이메일주소, 비밀번호, 주소, 연락처, 성별, 이름, 생일, 성명, 신용카드번호,
                <br />
                은행계좌 등 결제정보&gt;
                <br />
                선택항목 : &lt;관심분야, 과거 구매내역&gt;
                ...
                <br />
                <br />
                ② 정보주체께서는 회사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및
                처리해드릴 것입니다.
                <br />
                <br />
                ...
                <br />
                이 개인정보 처리방침은 2021. 03.15부터 적용됩니다.
                <br />
            </p>
            <style jsx>{`
                p {
